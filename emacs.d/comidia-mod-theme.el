...
(custom-theme-set-faces
 ...
 `(header-line ((t (:family "ProggyCleanTT" :width condensed :box (:line-width 1 :style none) :background "grey20" :foreground "grey90" :box nil))))
 ...
 `(modeline-mousable-minor-mode ((t (:background "Gray10" :foreground "SteelBlue" :box (:line-width 1 :style none) :width condensed :family "ProggyCleanTT"))))
 `(modeline-mousable ((t (:background "Gray10" :foreground "SteelBlue" :box (:line-width 1 :style none) :width condensed :family "ProggyCleanTT"))))
